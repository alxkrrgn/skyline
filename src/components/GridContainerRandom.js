...
const allItems = [
    ...
    { title: "Financial Planning", description: "We offer comprehensive financial planning services to help clients achieve their long-term financial goals. Through personalized strategies, we ensure that investments align with specific objectives, whether retirement, education, or wealth preservation." },
...
const GridContainerRandom = () => {
    ...
    <section>
          <div className="grid-container nested-grid">
                ...
                {gridContainerContent.map((item, index) => (
...
export default GridContainerRandom;
